...
Firstly, I will use light work that will make my C language fundamentals strong and later I will focus on further programming languages.

I am having some issues with my windows while downloading MinGW, and the gcc compiler is not working, now, I have to use other online compilers to make sure the code will run without any error, and to check if it is valid or not.
